...
protected:
	...
	virtual string GeneratePassthroughFileColumnStatsCTEBody(const CTERequirement &req, TableIndex table_id);
...
private:
	...
	string GenerateCTESectionFromRequirements(const unordered_map<idx_t, CTERequirement> &requirements,
	                                          TableIndex table_id, bool metadata_passthrough = false);
