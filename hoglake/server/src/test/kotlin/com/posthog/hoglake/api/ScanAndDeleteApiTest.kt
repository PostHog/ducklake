...
class ScanAndDeleteApiTest {
    ...
    private fun seedSpec(catalogName: String, tableName: String) {
    ...
    @Test
    fun `commit with partition values and deletes then scan`() = api { client ->
        ...
        val deleteCommit = client.postJson(
            "/v1/catalogs/sc/commit",
            """
    ...
    @Test
    fun `scan resolution errors on the wire`() = api { client ->
